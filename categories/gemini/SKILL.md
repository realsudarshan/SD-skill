---
name: skill-starter-gemini
description: Install the Skill Starter Pack Gemini provider bundle by following this folder's paths.txt.
---

# Gemini Bundle

Use this when the user asks for Gemini CLI, Gemini API, or Gemini provider skills.
