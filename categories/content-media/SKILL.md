---
name: skill-starter-content-media
description: Install the Skill Starter Pack content/media bundle by following this folder's paths.txt.
---

# Content Media Bundle

Use this when the user asks for images, audio, screenshots, transcription, or publishing workflows.
