---
name: skill-starter-ai-api
description: Install the Skill Starter Pack AI/API bundle by following this folder's paths.txt.
---

# AI API Bundle

Use this when the user asks for Gemini, image generation, speech, transcription, or AI API workflows.
