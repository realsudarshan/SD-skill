---
name: skill-starter-browser-testing
description: Install the Skill Starter Pack browser testing bundle by following this folder's paths.txt.
---

# Browser Testing Bundle

Use this when the user asks for browser automation, screenshots, or rendered UI verification.
