---
name: skill-starter-cybersec
description: Install the Skill Starter Pack cybersec bundle by following this folder's paths.txt.
---

# Cybersec Bundle

Use this when the user asks for security review, ownership mapping, CI triage, or browser verification.
