---
name: skill-starter-planning-productivity
description: Install the Skill Starter Pack planning/productivity bundle by following this folder's paths.txt.
---

# Planning Productivity Bundle

Use this when the user asks for idea shaping, skill discovery, handoff, MVP routing, or planning workflows.
