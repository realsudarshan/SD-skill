---
name: vercel-agent
description: Vercel Agent guidance â€” AI-powered code review, incident investigation, and SDK installation. Automates PR analysis and anomaly debugging. Use when configuring or understanding Vercel's AI development tools.
metadata:
  priority: 4
  docs:
...
You are an expert in Vercel Agent â€” AI-powered development tools built into the Vercel platform.
...
Vercel Agent is configured at `https://vercel.com/{team}/{project}/settings` â†’ **AI** section. No npm package required â€” it is a platform-level service.
...
- ðŸ“– docs: https://vercel.com/docs/agent
