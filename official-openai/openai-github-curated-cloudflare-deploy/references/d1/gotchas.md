...
| Read replicas | âŒ Not available | âœ… Available | Paid add-on for lower latency |
| Sessions API | âŒ Not available | âœ… Up to 15 min | For migrations and heavy operations |
