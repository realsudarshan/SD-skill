...
- Persist state between steps (minutes â†’ weeks)
...
- **Events**: `waitForEvent()` for webhooks/approvals (timeout: 1h â†’ 365d)
...
**Getting Started:** configuration.md â†’ api.md â†’ patterns.md
