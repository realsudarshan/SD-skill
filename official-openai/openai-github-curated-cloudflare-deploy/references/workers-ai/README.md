...
| Function calling | âœ… Supported (select models) | âœ… Supported |
...
**Start here**: Quick Start above â†’ configuration.md (setup)

**Common tasks**:
- First time setup: configuration.md â†’ Add binding + deploy
- Choose model: Model Selection Decision Tree (above) â†’ api.md
- Build RAG: patterns.md â†’ Vectorize integration
- Optimize costs: Model Selection + gotchas.md (rate limits)
- Debugging: gotchas.md â†’ Common errors
