...
|---------|-----------|-------|
| SELECT, WHERE, GROUP BY, HAVING | âœ… | Standard support |
| COUNT, SUM, AVG, MIN, MAX | âœ… | Standard aggregations |
| ORDER BY partition/aggregation | âœ… | See above |
| LIMIT | âœ… | Max 10,000 |
| Column aliases | âŒ | No AS alias |
| Expressions in SELECT | âŒ | No col1 + col2 |
| ORDER BY non-partition | âŒ | Fails at runtime |
| JOINs, subqueries, CTEs | âŒ | Denormalize at write time |
| Window functions, UNION | âŒ | Use external engines |
| INSERT/UPDATE/DELETE | âŒ | Use PyIceberg/Pipelines |
| Nested columns, arrays, JSON | âŒ | Flatten at write time |
