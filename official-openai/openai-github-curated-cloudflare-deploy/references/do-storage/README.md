...
|---------|---------------|------|------|
| SQLite (recommended) | `new_sqlite_classes` | SQL + sync KV + async KV | âœ… |
| KV (legacy) | `new_classes` | async KV only | âŒ |
...
**New to DO storage:** configuration.md â†’ api.md â†’ patterns.md â†’ gotchas.md
**Building features:** patterns.md â†’ api.md â†’ gotchas.md
**Debugging issues:** gotchas.md â†’ api.md
