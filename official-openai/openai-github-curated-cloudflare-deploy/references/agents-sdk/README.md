...
| Build chat agent | README â†’ api.md (AIChatAgent) â†’ patterns.md |
| Setup project | README â†’ configuration.md |
| Add React frontend | README â†’ api.md (Client Hooks) â†’ patterns.md |
| Build MCP server | api.md (MCP) â†’ patterns.md |
| Background tasks | api.md (Scheduling, Task Queue) â†’ patterns.md |
