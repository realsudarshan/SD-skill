...
|--------|--------|---------|------------|-------------|
| `block` | âœ… | âŒ | âœ… | Block request with 403 |
| `challenge` | âœ… | âŒ | âœ… | Show CAPTCHA challenge |
| `js_challenge` | âœ… | âŒ | âœ… | JS-based challenge |
| `managed_challenge` | âœ… | âŒ | âœ… | Smart challenge (recommended) |
| `log` | âœ… | âŒ | âœ… | Log only, don't block |
| `skip` | âœ… | âŒ | âŒ | Skip rule evaluation |
| `execute` | âŒ | âœ… | âŒ | Deploy managed ruleset |
