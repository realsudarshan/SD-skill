...
Dashboard â†’ Web Analytics â†’ Add site â†’ Select hostname â†’ Done
...
Dashboard â†’ Web Analytics â†’ Add site â†’ Enter hostname â†’ Copy snippet
...
- Found in: Dashboard â†’ Web Analytics â†’ Manage site
...
1. DevTools Network â†’ filter `cloudflareinsights` â†’ see `beacon.min.js` + data request
