...
**âš ï¸ Framework Status** (2026):
- âœ… **Supported**: SvelteKit, Astro, Nuxt, Qwik, Solid Start
- âŒ **Deprecated**: Next.js (`@cloudflare/next-on-pages`), Remix (`@remix-run/cloudflare-pages`)
...
Dashboard â†’ Settings â†’ Build â†’ Root directory. Set to subproject (e.g., `apps/web`).
