...
**Solution:**
1. Check MTU (1500â†“/1476â†‘ for v1, 1500 both for v2)
...
|--------------|---------|----------|
| Single interconnect for production | No SLA, single point of failure | Use â‰¥2 with device diversity |
...
| Assuming BGP session = traffic flowing | BGP up â‰  routes installed | Verify routing tables + test traffic |
