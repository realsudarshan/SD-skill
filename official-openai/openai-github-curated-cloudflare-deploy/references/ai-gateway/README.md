...
- **Using Vercel AI SDK** â†’ Pattern 1 (recommended) - see [sdk-integration.md](./sdk-integration.md)
- **Using OpenAI SDK** â†’ Pattern 2 - see [sdk-integration.md](./sdk-integration.md)
- **Cloudflare Worker + Workers AI** â†’ Pattern 3 - see [sdk-integration.md](./sdk-integration.md)
- **Direct HTTP (any language)** â†’ Pattern 4 - see [configuration.md](./configuration.md)
- **Framework (LangChain, etc.)** â†’ See [sdk-integration.md](./sdk-integration.md)
...
```
Your App â†’ AI Gateway â†’ AI Provider (OpenAI, Anthropic, etc.)
         â†“
