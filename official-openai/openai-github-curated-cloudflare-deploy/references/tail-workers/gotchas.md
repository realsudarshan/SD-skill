...
```typescript
// âŒ WRONG: const date = new Date(event.eventTimestamp * 1000);
// âœ… CORRECT: const date = new Date(event.eventTimestamp);
```
