...
**Response includes**:
- `uid`: Key identifier
- `key`: The actual secret key (only returned on creationâ€”save immediately)
...
**Port 53 Warning**: Filter port 53 URLs for browser clientsâ€”blocked by Chrome/Firefox. See [gotchas.md](./gotchas.md#using-port-53-in-browsers).
