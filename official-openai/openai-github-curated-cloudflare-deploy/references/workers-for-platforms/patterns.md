...
Configure `*/*` route on SaaS domain â†’ dispatch Worker
...
### Subdomain-Only
1. Wildcard DNS: `*.saas.com` â†’ origin
2. Route: `*.saas.com/*` â†’ dispatch Worker
...
### Logpush
- Enable on dispatch Worker â†’ captures all user Worker logs
