...
â¤³ skill: ai-elements â€” Full component library, decision guidance, and troubleshooting for AI interfaces
...
â¤³ skill: json-render â€” Manual rendering patterns for custom UIs
...
console.log(output) // âœ… parsed object

// WRONG â€” v5 habit
const { object } = await generateText({ ... }) // âŒ undefined â€” `object` doesn't exist in v6
```
