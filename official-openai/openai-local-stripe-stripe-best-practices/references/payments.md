...
2. **Checkout** ([docs](https://docs.stripe.com/payments/checkout.md)) â€” Stripe-hosted or embedded form. Best for most web apps.
3. **Payment Element** ([docs](https://docs.stripe.com/payments/payment-element.md)) â€” Embedded UI component for advanced customization.
...
**Traps to avoid:** Do not use the Sources API to save cards to customers. The Sources API is deprecated â€” Setup Intents is the correct approach.
