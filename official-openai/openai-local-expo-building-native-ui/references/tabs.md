...
- Tabs must be static â€” no dynamic addition/removal at runtime (remounts navigator, loses state)
...
**Important**: Two instances render simultaneously â€” store state outside the component (props, context, or external store).
