...
- `[id].tsx` â†’ `useLocalSearchParams<{ id: string }>()`
- `[slug].tsx` â†’ `useLocalSearchParams<{ slug: string }>()`
...
app/
  ...
  (home)/
    _layout.tsx â€” <Stack />
    index.tsx â€” <ScrollView />
  (settings)/
    _layout.tsx â€” <Stack />
    index.tsx â€” <ScrollView />
  (home,settings)/
    info.tsx â€” <ScrollView /> (shared across tabs)
```
...
```
app/
  _layout.tsx â€” <NativeTabs />
  (index,search)/
    _layout.tsx â€” <Stack />
    index.tsx â€” Main list
    search.tsx â€” Search view
    i/[id].tsx â€” Detail page
components/
  theme.tsx
  list.tsx
utils/
