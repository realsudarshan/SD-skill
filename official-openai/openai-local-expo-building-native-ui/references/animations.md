...
- `LinearTransition` â€” Smooth linear interpolation
- `SequencedTransition` â€” Sequenced property changes
- `FadingTransition` â€” Fade between states
...
- Avoid animating layout properties (width, height) when possible â€” prefer transforms
