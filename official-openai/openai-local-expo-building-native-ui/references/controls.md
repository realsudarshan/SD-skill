...
- Maximum 4 options â€” use a picker for more
- Keep labels short (1-2 words)
- Avoid custom colors â€” native styling adapts to dark mode
...
- **Haptics**: Switch and DateTimePicker have built-in haptics â€” don't add extra
- **Accessibility**: Native controls have proper accessibility labels by default
- **Dark Mode**: Avoid custom colors â€” native styling adapts automatically
