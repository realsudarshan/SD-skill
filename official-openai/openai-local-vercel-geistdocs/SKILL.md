---
name: geistdocs
description: Expert guidance for Geistdocs, Vercel's documentation template built with Next.js and Fumadocs â€” MDX authoring, configuration, AI chat, i18n, feedback, deployment. Use when creating documentation sites, configuring geistdocs, writing MDX content, or setting up docs infrastructure.
metadata:
  priority: 5
  docs:
...
# Geistdocs â€” Vercel Documentation Template
...
```
geistdocs.tsx          # Root config â€” Logo, nav, title, prompt, suggestions, github, translations
content/docs/          # MDX documentation content
  getting-started.mdx  # â†’ /docs/getting-started
  my-page.mdx          # â†’ /docs/my-page
  my-page.cn.mdx       # â†’ /cn/docs/my-page (i18n)
...
export const translations = {
  ...
  cn: { displayName: "ä¸­æ–‡", search: "æœå°‹æ–‡æª”" },
};
```
...
- **Headings**: H1â€“H6 with auto anchor links
...
### Edit on GitHub
Set `github` in config â†’ auto-generates edit links in the ToC sidebar. No env vars or API keys needed.
...
### Ask AI
AI chat assistant using `openai/gpt-4.1-mini` via Vercel AI Gateway. Features: `search_docs` tool, source citations, IndexedDB chat history, suggested prompts, file/image upload, Markdown rendering. Access via navbar button or `âŒ˜I` / `Ctrl+I`.
...
1. Push to GitHub
2. Import at vercel.com/new â†’ select repo
