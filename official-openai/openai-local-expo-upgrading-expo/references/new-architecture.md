...
- **JSI (JavaScript Interface)** â€” Direct synchronous calls between JS and native
- **Fabric** â€” New rendering system with concurrent features
- **TurboModules** â€” Lazy-loaded native modules with type safety
...
1. **Clear caches** â€” `npx expo start --clear`
2. **Clean prebuild** â€” `npx expo prebuild --clean`
3. **Check native modules** â€” Ensure all dependencies support New Architecture
4. **Review console warnings** â€” Legacy modules log compatibility warnings
