...
- **Actions** â€” Functions that handle async transitions
- **useOptimistic** â€” Optimistic UI updates
- **useFormStatus** â€” Form submission state (web)
- **Document Metadata** â€” Native `<title>` and `<meta>` support (web)
