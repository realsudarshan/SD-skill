...
description: Vercel Routing Middleware guidance â€” request interception before cache, rewrites, redirects, personalization. Works with any framework. Supports Edge, Node.js, and Bun runtimes. Use when intercepting requests at the platform level.
metadata:
  priority: 6
  docs:
...
- ðŸ“– docs: https://vercel.com/docs/routing-middleware
- ðŸ“– API reference: https://vercel.com/docs/routing-middleware/api
- ðŸ“– getting started: https://vercel.com/docs/routing-middleware/getting-started
