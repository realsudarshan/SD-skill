# Templates / Style Packs (DOTX) â€” apply consistent styles
...
- Tables didnâ€™t reflow in a way that breaks readability
- Page count changes are acceptable

## Pitfalls
- Style packs can change pagination. Thatâ€™s expected.
