...
2. Keep heading hierarchy consistent: donâ€™t jump from Heading 1 â†’ Heading 3 unless the document truly skips a level.
3. Numbered headings are *not* the same thing as bullet lists. If you need Wordâ€™s multilevel numbering, use a template where the numbering definitions already exist (DOTX), or accept that itâ€™s brittle to generate from scratch.
...
## Render â†’ PNG review checklist (headings)
...
## Common pitfalls
- Mixing manual numbering (â€œ1. â€ typed in text) with TOC-generated numbering
