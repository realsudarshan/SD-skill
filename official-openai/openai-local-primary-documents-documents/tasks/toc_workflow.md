...
Defaults: include Heading 1â€“3.

3) Open in Word and update fields:
- `Ctrl+A` â†’ `F9` (Update Fields)
- Save
...
## Render â†’ PNG review checklist (TOC)
- TOC is present (not blank)
- Indentation reflects heading levels
- Page numbers in TOC match the actual headingsâ€™ pages
- Headings that should appear do appear (and vice versa)
- No placeholder text remains (e.g., â€œTOC will populateâ€¦â€)

## Common pitfalls
- **Headings not styled** â†’ TOC is empty.
- **Manual numbering/direct formatting** â†’ TOC levels/indentation drift.
- **Fields not updated** â†’ TOC and page numbers stale after edits.
