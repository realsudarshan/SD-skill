...
- `NUMPAGES` â€” total page count
- `TOC` â€” table of contents
- `REF` / `PAGEREF` â€” cross references (often "see page X")

## When this matters
- PDF/PNG render shows placeholders (e.g., TOC looks empty, refs show wrong page, page numbers all â€œ1â€).
...
## Render â†’ PNG review checklist (fields)
...
- No placeholder text like â€œ(TOC will populate...)â€ remains
