...
1. **JSON Schema** â€” https://api.expo.dev/v2/workflows/schema
...
2. **Syntax Documentation** â€” https://raw.githubusercontent.com/expo/expo/refs/heads/main/docs/pages/eas/workflows/syntax.mdx
   - Overview of workflow YAML syntax
   - Examples and English explanations
   - Expression syntax and contexts

3. **Pre-packaged Jobs** â€” https://raw.githubusercontent.com/expo/expo/refs/heads/main/docs/pages/eas/workflows/pre-packaged-jobs.mdx
...
- `name` â€” Display name for the workflow
- `on` â€” Triggers that start the workflow (at least one required)
- `jobs` â€” Job definitions (required)
- `defaults` â€” Shared defaults for all jobs
- `concurrency` â€” Control parallel workflow runs
...
- `github.*` â€” GitHub repository and event information
- `inputs.*` â€” Values from `workflow_dispatch` inputs
- `needs.*` â€” Outputs and status from dependent jobs
- `jobs.*` â€” Job outputs (alternative syntax)
- `steps.*` â€” Step outputs within custom jobs
- `workflow.*` â€” Workflow metadata
