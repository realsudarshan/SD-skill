...
**External (10,000 max)**: Beta users. First build needs review (~24h), then instant. Always have an external groupâ€”even if it's just friends. Real feedback beats assumptions.
...
- Add release notesâ€”testers actually read them
