...
**Be specific**:
âœ“ "Implement user login with email/password"
âœ— "Add login"

**Include context**:
âœ“ "Dashboard: Add revenue chart widget"
âœ— "Add chart"
...
â˜ Each task has clear objective
â˜ Acceptance criteria are testable
â˜ Dependencies identified
â˜ Appropriate size (1-2 days)
â˜ Priority assigned
â˜ Linked to spec/plan
â˜ Proper sequencing
â˜ Resources noted
