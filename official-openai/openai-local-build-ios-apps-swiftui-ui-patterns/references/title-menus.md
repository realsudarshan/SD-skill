...
Use a title menu in the navigation bar to provide contextâ€‘specific filtering or quick actions without adding extra chrome.
...
- Donâ€™t overload the menu with too many options.
