...
- **The skip test:** Do the first 3 words describe the userâ€™s intent? If not,
  rewrite.
...
- **Micro-state cycles:** For tasks $> 3$ seconds, cycle through specific
  sub-states (e.g., Parsing logs... âž” Identifying patterns...) to show momentum.
...
-  **Suggested prompts:** Offer specific text for the user to copy/click like
   â€œAsk Gemini: 'Explain this port error.'â€
