...
description: Install the Claude Code provider pack from Skill Starter Pack.
---

# Claude Code Pack

Do not treat this folder as one normal skill. This folder is a bundle manifest for Anthropic GitHub skills plus Claude Code-style local skills.
...
4. Summarize the installed Claude Code skills.
